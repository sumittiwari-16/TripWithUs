...
function sorthotelsbasedonpricing(price1, price2, pricing) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  let result = hotelscopy.sort((a, b) =>
    sorthotelsbasedonpricing(a, b, pricing)
  );
  res.json({ hotels: result });
});

function sortbasedonrating(rating1, rating2, rating) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let result = hotelscopy.sort((a, b) => sortbasedonrating(a, b, rating));
  res.json({ hotels: result });
});

function sortbyreviews(reviews1, reviews2, reviews) {
  if (reviews === 'least-to-most') {
    return reviews1.reviews - reviews2.reviews;
  } else {
    return reviews2.reviews - reviews1.reviews;
  }
}
...
function filterbucategory(hotel, category) {
...
app.get('/hotels/filter/category', (req, res) => {
  ...
  let hotelcopy = hotels.slice();
  let result = hotelcopy.filter((hotel) => filterbucategory(hotel, category));
  res.json({ hotels: result });
});
